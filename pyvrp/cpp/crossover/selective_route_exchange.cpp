...
namespace
{
std::pair<double, double> dataCentroid(pyvrp::ProblemData const &data)
{
    double x = 0;
    double y = 0;
...
std::pair<double, double> routeCentroid(pyvrp::ProblemData const &data,
                                        Route const &route)
{
    double x = 0;
    double y = 0;
...
{
    auto const [dataX, dataY] = dataCentroid(data);
    auto const [routeX, routeY] = routeCentroid(data, route);
