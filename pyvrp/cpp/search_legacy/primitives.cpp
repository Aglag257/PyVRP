...
public:
    ...
    pyvrp::search_legacy::Route const *route() const { return nullptr; }
...
pyvrp::Cost pyvrp::search_legacy::insertCost(Route::Node *U,
                                      Route::Node *V,
...
pyvrp::Cost pyvrp::search_legacy::removeCost(Route::Node *U,
                                      ProblemData const &data,
                                      CostEvaluator const &costEvaluator)
{
...
pyvrp::Cost pyvrp::search_legacy::inplaceCost(Route::Node *U,
                                       Route::Node *V,
                                       ProblemData const &data,
                                       CostEvaluator const &costEvaluator)
{
