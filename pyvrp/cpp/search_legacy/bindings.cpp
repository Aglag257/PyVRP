...
using pyvrp::search_legacy::Exchange;
using pyvrp::search_legacy::inplaceCost;
using pyvrp::search_legacy::insertCost;
using pyvrp::search_legacy::LocalSearch;
using pyvrp::search_legacy::NodeOperator;
using pyvrp::search_legacy::OperatorStatistics;
using pyvrp::search_legacy::RelocateWithDepot;
using pyvrp::search_legacy::removeCost;
using pyvrp::search_legacy::Route;
using pyvrp::search_legacy::RouteOperator;
using pyvrp::search_legacy::supports;
using pyvrp::search_legacy::SwapRoutes;
using pyvrp::search_legacy::SwapStar;
using pyvrp::search_legacy::SwapTails;

PYBIND11_MODULE(_search_legacy, m)
{
    py::class_<NodeOperator>(m, "NodeOperator");
    py::class_<RouteOperator>(m, "RouteOperator");

    py::class_<OperatorStatistics>(
        m, "OperatorStatistics", DOC(pyvrp, search_legacy, OperatorStatistics))
    ...
    py::class_<Exchange<1, 0>, NodeOperator>(
        m, "Exchange10", DOC(pyvrp, search_legacy, Exchange))
    ...
    py::class_<Exchange<2, 0>, NodeOperator>(
        m, "Exchange20", DOC(pyvrp, search_legacy, Exchange))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<Exchange<3, 0>, NodeOperator>(
        m, "Exchange30", DOC(pyvrp, search_legacy, Exchange))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<Exchange<1, 1>, NodeOperator>(
        m, "Exchange11", DOC(pyvrp, search_legacy, Exchange))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<Exchange<2, 1>, NodeOperator>(
        m, "Exchange21", DOC(pyvrp, search_legacy, Exchange))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<Exchange<3, 1>, NodeOperator>(
        m, "Exchange31", DOC(pyvrp, search_legacy, Exchange))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<Exchange<2, 2>, NodeOperator>(
        m, "Exchange22", DOC(pyvrp, search_legacy, Exchange))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<Exchange<3, 2>, NodeOperator>(
        m, "Exchange32", DOC(pyvrp, search_legacy, Exchange))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<Exchange<3, 3>, NodeOperator>(
        m, "Exchange33", DOC(pyvrp, search_legacy, Exchange))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<SwapRoutes, RouteOperator>(
        m, "SwapRoutes", DOC(pyvrp, search_legacy, SwapRoutes))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<SwapStar, RouteOperator>(
        m, "SwapStar", DOC(pyvrp, search_legacy, SwapStar))
    ...
    py::class_<SwapTails, NodeOperator>(
        m, "SwapTails", DOC(pyvrp, search_legacy, SwapTails))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<RelocateWithDepot, NodeOperator>(
        m, "RelocateWithDepot", DOC(pyvrp, search_legacy, RelocateWithDepot))
        .def(py::init<pyvrp::ProblemData const &>(),
             py::arg("data"),
             py::keep_alive<1, 2>())  // keep data alive
        .def_property_readonly("statistics",
    ...
    py::class_<LocalSearch::Statistics>(
        m, "LocalSearchStatistics", DOC(pyvrp, search_legacy, LocalSearch, Statistics))
    ...
    py::class_<Route>(m, "Route", DOC(pyvrp, search_legacy, Route))
    ...
    py::class_<Route::Node>(m, "Node", DOC(pyvrp, search_legacy, Route, Node))
    ...
    m.def("insert_cost",
          ...
          py::arg("data"),
          py::arg("cost_evaluator"),
          DOC(pyvrp, search_legacy, insertCost));
    ...
    m.def("inplace_cost",
          ...
          py::arg("data"),
          py::arg("cost_evaluator"),
          DOC(pyvrp, search_legacy, inplaceCost));
    ...
    m.def("remove_cost",
          ...
          py::arg("data"),
          py::arg("cost_evaluator"),
          DOC(pyvrp, search_legacy, removeCost));
}
